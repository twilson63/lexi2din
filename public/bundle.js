...
},{"./lexi":4,"./rxnorm":6,"angular-ui-router/release/angular-ui-router":7,"angular/angular":8,"underscore":9}],2:[function(require,module,exports){
...
module.exports = function($scope, doc) {
  $scope.doc = doc;
};
  ...
  .config(function($stateProvider) {
    $stateProvider
      ...
      .state('lexi.list', {
        ...
        template: "<div class=\"container\">\n  <ul class=\"list\">\n    <li ng-repeat=\"doc in docs\" >\n      <a ui-sref=\"lexi.show({ id: doc._id })\">{{doc.generic_product_name}}</a>\n    </li>\n  </ul>\n</div>\n\n"
      })
      .state('lexi.show', {
        url:'/:id',
...
},{"./controllers/list.js":2,"./controllers/show.js":3,"fs":10}],5:[function(require,module,exports){
  ...
  .config(function($stateProvider) {
    $stateProvider
      .state('rxnorm', {
        ...
        template: Buffer("PGgxPlJ4Tm9ybTwvaDE+Cg==","base64")
      });
   });

}).call(this,require("buffer").Buffer)
},{"./controllers/list.js":5,"buffer":11,"fs":10}],7:[function(require,module,exports){
/**
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.15-build.2387+sha.46bd6dc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.15-build.2387+sha.46bd6dc',    // all of these placeholder strings will be replaced by grunt's
