...
},{"./lexi":3,"./rxnorm":5,"angular-ui-router/release/angular-ui-router":6,"angular/angular":7}],2:[function(require,module,exports){
  ...
  .config(function($stateProvider) {
    $stateProvider
      ...
      .state('lexi.list', {
        ...
        template: "<h1>FOOOOOOOOO  {{foo}} </h1>\n<h3>BEEP</h3>\n\n<input ng-model='foo'>\n"
      })
      ;
   });

},{"./controllers/list.js":2,"fs":8}],4:[function(require,module,exports){
module.exports = function($scope) {
};
...
},{"./controllers/list.js":4,"buffer":9,"fs":8}],6:[function(require,module,exports){
/**
